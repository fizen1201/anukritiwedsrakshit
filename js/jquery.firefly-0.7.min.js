!function(a)
{var b={total:100,ofTop:0,ofLeft:0,on:"document.body",twinkle:.2,minPixel:10,maxPixel:20,color:"#fff",namespace:"jqueryFireFly",zIndex:Math.ceil(20*Math.random())-1,borderRadius:"50%",_paused:!1};
